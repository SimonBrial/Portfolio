        ...
        <div className="theme-container" onKeyUp={keyHandler}>
            <div className="color-selector-theme">
                <div className="color-selector">
                    <span className="color-square" style={{ backgroundColor: `${(themes !== undefined) ? themes : "#0038E0"}` }}></span>
                </div>
                <button
            ...
            <div className="bg-container">
                <div className="bg-selector-theme-left" style={{ backgroundColor: `${(themes !== undefined) ? themes : "#0038E0"}` }} ></div>
                <div className="bg-selector-theme-right" style={{ backgroundColor: `${(themes !== undefined) ? themes : "#0038E0"}` }} ></div>
            </div>
            {isShow ? (
